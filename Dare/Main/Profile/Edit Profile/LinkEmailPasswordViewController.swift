//
//  LinkEmailPasswordViewController.swift
//  Dare
//
...
class LinkEmailPasswordViewController: UIViewController {
    ...
    func setUpElements() {
        ...
        enterInfoLabel.text = "Enter your new password"
    ...
    @objc func continueTouchUpInside() {
        if validatePassword() != nil {
            ...
            FirebaseUtilities.linkEmailToAccount(currentUser: currentUser, email: email, password: password) { (error) in
                if error != nil {
